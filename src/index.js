...
var registerNameInput = document.getElementById("register-name-input");
var registerPasswordInput = document.getElementById("register-password-input");
var registerRepasswordInput = document.getElementById("register-repassword-input");
var registerForm = document.getElementById("register-form");
var fetchDataLogin = function () { return __awaiter(_this, void 0, void 0, function () {
    var response, json, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("http://localhost:4400/auth/login", {
                        method: "POST",
                        body: JSON.stringify({
...
var fetchDataRegister = function () { return __awaiter(_this, void 0, void 0, function () {
    var response, json, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("http://localhost:4400/auth/register", {
                        method: "POST",
                        body: JSON.stringify({
